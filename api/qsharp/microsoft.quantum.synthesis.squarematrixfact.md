...
---
# <a name="squarematrixfact-function"></a>SquareMatrixFact función)
...
Comprueba que la matriz dada representa una matriz cuadrada.
...
### <a name="matrix--complex"></a>matriz: [compleja](xref:Microsoft.Quantum.Math.Complex)[] []
