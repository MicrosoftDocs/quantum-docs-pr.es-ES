...
### <a name="onequalop--unit--unit-adj"></a>onEqualOp: [unidad de unidad](xref:microsoft.quantum.lang-ref.unit) => [Unit](xref:microsoft.quantum.lang-ref.unit)




### <a name="onnonequalop--unit--unit-adj"></a>onNonEqualOp: [unidad de unidad](xref:microsoft.quantum.lang-ref.unit) => [Unit](xref:microsoft.quantum.lang-ref.unit)
