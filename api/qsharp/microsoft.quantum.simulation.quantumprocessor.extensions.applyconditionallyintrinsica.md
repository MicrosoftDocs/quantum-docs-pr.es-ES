...
ms.locfileid: "98858515"
---
# <a name="applyconditionallyintrinsica-operation"></a>Operación ApplyConditionallyIntrinsicA
...
### <a name="onequalop--unit--unit--is-adj"></a>onEqualOp: la unidad de [unidad](xref:microsoft.quantum.lang-ref.unit) => [](xref:microsoft.quantum.lang-ref.unit) es ADJ




### <a name="onnonequalop--unit--unit--is-adj"></a>onNonEqualOp: la unidad de [unidad](xref:microsoft.quantum.lang-ref.unit) => [](xref:microsoft.quantum.lang-ref.unit) es ADJ
