...
title: StandardTransformation función)
...
ms.locfileid: "98857781"
---
# <a name="standardtransformation-function"></a>StandardTransformation función)
...
### <a name="variate--double"></a>variados: [Double](xref:microsoft.quantum.lang-ref.double)
