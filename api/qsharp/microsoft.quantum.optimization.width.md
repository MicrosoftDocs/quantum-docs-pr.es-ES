...
ms.locfileid: "98842638"
---
# <a name="width-function"></a>Width, función
...
Devuelve el ancho de un intervalo.
...
### <a name="left--double"></a>izquierda: [doble](xref:microsoft.quantum.lang-ref.double)




### <a name="right--double"></a>Right: [doble](xref:microsoft.quantum.lang-ref.double)
