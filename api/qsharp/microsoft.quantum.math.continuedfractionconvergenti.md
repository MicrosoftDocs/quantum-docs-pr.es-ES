...
title: ContinuedFractionConvergentI función)
...
ms.locfileid: "92732749"
---
# <a name="continuedfractionconvergenti-function"></a>ContinuedFractionConvergentI función)
...
### <a name="fraction--fraction"></a>fracción: [fracción](xref:Microsoft.Quantum.Math.Fraction)
...
## <a name="output--fraction"></a>Salida: [fracción](xref:Microsoft.Quantum.Math.Fraction)
