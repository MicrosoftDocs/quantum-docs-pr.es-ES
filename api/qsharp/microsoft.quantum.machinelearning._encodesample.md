...
ms.locfileid: "96228226"
---
# <a name="_encodesample-function"></a>_EncodeSample función)
...
### <a name="sample--labeledsample"></a>ejemplo: [LabeledSample](xref:Microsoft.Quantum.MachineLearning.LabeledSample)





## <a name="output--labeledsamplestategenerator"></a>Salida: ([LabeledSample](xref:Microsoft.Quantum.MachineLearning.LabeledSample),[StateGenerator](xref:Microsoft.Quantum.MachineLearning.StateGenerator))
