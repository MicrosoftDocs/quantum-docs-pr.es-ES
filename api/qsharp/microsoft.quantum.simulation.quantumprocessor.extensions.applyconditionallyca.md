...
### <a name="onequalop--t--unit--is-adj--ctl"></a>onEqualOp: ' t => [unidad](xref:microsoft.quantum.lang-ref.unit)  es ADJ + CTL
...
### <a name="onnonequalop--u--unit--is-adj--ctl"></a>onNonEqualOp: ' U => [unidad](xref:microsoft.quantum.lang-ref.unit)  es ADJ + CTL
