...
title: JordanWignerClusterOperatorEvolutionSet función)
...
ms.locfileid: "98839024"
---
# <a name="jordanwignerclusteroperatorevolutionset-function"></a>JordanWignerClusterOperatorEvolutionSet función)
...
`EvolutionSet`Que asigna un `GeneratorIndex` para la base de JordanWigner a un ' EvolutionUnitary.