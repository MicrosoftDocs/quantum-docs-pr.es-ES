...
---
# <a name="accumulatedbitsizel-function"></a>AccumulatedBitsizeL función)
...
Función auxiliar que se usa para calcular de forma recursiva el bit a bit de un valor.
...
### <a name="bitsize--int"></a>bits: [int](xref:microsoft.quantum.lang-ref.int)
