...
---
# <a name="inplacexorbe-operation"></a>Operación InPlaceXorBE
...
> [!WARNING]
> InPlaceXorBE está en desuso. Use <xref:ApplyReversedOpLECA(ApplyXorInPlace(value, _), target)> en su lugar.
>
> Esta operación se ha quitado.
...
### <a name="target--bigendian"></a>destino: [bigEndian](xref:Microsoft.Quantum.Arithmetic.BigEndian)
