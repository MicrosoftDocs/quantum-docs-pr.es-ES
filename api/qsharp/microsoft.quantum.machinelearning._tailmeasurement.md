...
ms.locfileid: "96196674"
---
# <a name="_tailmeasurement-function"></a>_TailMeasurement función)
...
## <a name="output--qubit--__invalidresult__"></a>Salida: [qubit](xref:microsoft.quantum.lang-ref.qubit)[] => __no <Result> válido__ 
