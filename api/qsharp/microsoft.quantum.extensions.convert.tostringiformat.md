...
ms.locfileid: "98823278"
---
# <a name="tostringiformat-function"></a>ToStringIFormat función)
...
> [!WARNING]
> ToStringIFormat está en desuso. Use <xref:Microsoft.Quantum.Convert.IntAsStringWithFormat> en su lugar.
>
> Use @"microsoft.quantum.convert.intasstringwithformat".
...
### <a name="fmt--string"></a>FMT: [cadena](xref:microsoft.quantum.lang-ref.string)
