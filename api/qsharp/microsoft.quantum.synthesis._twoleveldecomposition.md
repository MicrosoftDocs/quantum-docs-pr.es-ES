...
---
# <a name="_twoleveldecomposition-function"></a>_TwoLevelDecomposition función)
...
## <a name="output--complexintint"></a>Salida: ([Complex](xref:Microsoft.Quantum.Math.Complex)[] [],[int](xref:microsoft.quantum.lang-ref.int),[int](xref:microsoft.quantum.lang-ref.int)) []
