...
title: _MisclassificationRate función)
...
ms.locfileid: "92732396"
---
# <a name="_misclassificationrate-function"></a>_MisclassificationRate función)
...
### <a name="labels--int"></a>Etiquetas: [int](xref:microsoft.quantum.lang-ref.int)[]
