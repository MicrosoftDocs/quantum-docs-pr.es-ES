...
title: _OptimizedBEXY operación
...
ms.locfileid: "98851512"
---
# <a name="_optimizedbexy-operation"></a>_OptimizedBEXY operación
...
### <a name="accumulator--qubit"></a>acumulador: [qubit](xref:microsoft.quantum.lang-ref.qubit)
