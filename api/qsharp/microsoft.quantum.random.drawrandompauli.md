...
title: Operación DrawRandomPauli
...
ms.locfileid: "96210138"
---
# <a name="drawrandompauli-operation"></a>Operación DrawRandomPauli
...
Dibuja un valor Pauli aleatorio.
...
`PauliI`,, `PauliX` `PauliY` O con la `PauliZ` misma probabilidad.