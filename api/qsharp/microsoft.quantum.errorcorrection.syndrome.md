...
ms.locfileid: "96200278"
---
# <a name="syndrome-user-defined-type"></a>Síndrome (tipo definido por el usuario)
...
Tipo para los resultados de `Result[]` la medición que especifican un síndrome de error de un código Quantum.
