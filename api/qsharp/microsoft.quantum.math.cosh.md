...
ms.locfileid: "98848383"
---
# <a name="cosh-function"></a>Cosh (función)
...
### <a name="d--double"></a>d: [doble](xref:microsoft.quantum.lang-ref.double)
...
Vea [System. Math. cosh](https://docs.microsoft.com/dotnet/api/system.math.cosh) para obtener más detalles.