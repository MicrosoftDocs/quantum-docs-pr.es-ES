...
ms.locfileid: "96199921"
---
# <a name="dumpregister-function"></a>DumpRegister función)

Espacio de nombres: [Microsoft. Quantum. Extensions. Diagnostics](xref:Microsoft.Quantum.Extensions.Diagnostics)

Paquete: [Microsoft. Quantum. QSharp. Core](https://nuget.org/packages/Microsoft.Quantum.QSharp.Core)


> [!WARNING]
> DumpRegister está en desuso. Use <xref:Microsoft.Quantum.Diagnostics.DumpRegister> en su lugar.
>
> Use @"microsoft.quantum.diagnostics.dumpregister".
