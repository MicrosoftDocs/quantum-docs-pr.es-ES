...
ms.locfileid: "96203027"
---
# <a name="masktoqubitspair-function"></a>MaskToQubitsPair función)
...
Transformación de la máscara de bits de control y de destino en un par de qubits de control y de destino qubits
...
### <a name="mask--mcmtmask"></a>máscara: [MCMTMask](xref:Microsoft.Quantum.Synthesis.MCMTMask)
