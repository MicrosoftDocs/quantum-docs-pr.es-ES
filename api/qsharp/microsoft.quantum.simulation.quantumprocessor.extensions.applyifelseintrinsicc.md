...
ms.locfileid: "96228889"
---
# <a name="applyifelseintrinsicc-operation"></a>Operación ApplyIfElseIntrinsicC
...
### <a name="onresultzeroop--unit--unit--is-ctl"></a>onResultZeroOp: la unidad de [unidad](xref:microsoft.quantum.lang-ref.unit) => [Unit](xref:microsoft.quantum.lang-ref.unit) es CTL




### <a name="onresultoneop--unit--unit--is-ctl"></a>onResultOneOp: la unidad de [unidad](xref:microsoft.quantum.lang-ref.unit) => [Unit](xref:microsoft.quantum.lang-ref.unit) es CTL
