...
---
# <a name="_trainsequentialclassifieratmodel-operation"></a>_TrainSequentialClassifierAtModel operación
...
## <a name="output--sequentialmodel"></a>Salida: [SequentialModel](xref:Microsoft.Quantum.MachineLearning.SequentialModel)
