...
title: Tipo definido por el usuario BigDiscreteDistribution
...
ms.locfileid: "98855790"
---
# <a name="bigdiscretedistribution-user-defined-type"></a>Tipo definido por el usuario BigDiscreteDistribution
...
Representa una distribución de probabilidad de univariante en enteros de tamaño arbitrario.
...
### <a name="sample--unit--bigint"></a>Ejemplo: [](xref:microsoft.quantum.lang-ref.unit) => [BigInt](xref:microsoft.quantum.lang-ref.bigint) de unidad 
