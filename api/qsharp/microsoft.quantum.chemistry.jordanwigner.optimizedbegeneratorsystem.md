...
---
# <a name="optimizedbegeneratorsystem-user-defined-type"></a>Tipo definido por el usuario OptimizedBEGeneratorSystem
...
Función que devuelve `OptimizedBETermIndex` datos para `n` el término dado un entero `n` , junto con el número de términos de la primera `Int` y la suma de los valores absolutos de todos los coeficientes de los términos de `Double` .
