...
ms.locfileid: "96227750"
---
# <a name="negationc-function"></a>NegationC función)
...
Devuelve la negación unaria de una entrada.
...
Valor cuya negación se va a devolver.



## <a name="output--complex"></a>Salida: [complejo](xref:Microsoft.Quantum.Math.Complex)

La negación unaria de `input` .