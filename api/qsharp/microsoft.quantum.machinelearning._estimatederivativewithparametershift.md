...
title: _EstimateDerivativeWithParameterShift operación
...
ms.locfileid: "96212314"
---
# <a name="_estimatederivativewithparametershift-operation"></a>_EstimateDerivativeWithParameterShift operación
...
### <a name="parameters--doubledouble"></a>parámetros: ([Double](xref:microsoft.quantum.lang-ref.double)[],[Double](xref:microsoft.quantum.lang-ref.double)[])
