...
ms.locfileid: "98850147"
---
# <a name="intasdouble-function"></a>IntAsDouble función)
...
Convierte un entero dado en un número de punto flotante de precisión doble equivalente.
...
Vea [C# Convert. ToDouble](https://docs.microsoft.com/dotnet/api/system.convert.todouble?view=netframework-4.7.1#System_Convert_ToDouble_System_Int64_) para obtener más detalles.