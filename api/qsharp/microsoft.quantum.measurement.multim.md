...
---
# <a name="multim-operation"></a>Operación MultiM
...
Mide cada qubit en una matriz determinada en función del estándar.
...
Matriz de qubits que se va a medir.



## <a name="output--__invalidresult__"></a>Salida: __no <Result> válido__[]

Matriz de resultados de la medición.