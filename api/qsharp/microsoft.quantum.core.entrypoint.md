...
---
# <a name="entrypoint-user-defined-type"></a>EntryPoint (tipo definido por el usuario)
...
Atributo reconocido por el compilador que se usa para marcar el punto de entrada de un ejecutable.
