...
---
# <a name="transformztoy-operation"></a>Operación TransformZToY
...
Se utiliza para cambiar la base de un operador Z a un operador Y mediante la conjugación.
...
Qubit cuya base se va a cambiar.
