...
ms.locfileid: "92728024"
---
# <a name="_jordanwigneroptimizedblockencoding_-function"></a>_JordanWignerOptimizedBlockEncoding_ función)
...
## <a name="output--intintdoubleblockencodingreflection"></a>Salida: (([int](xref:microsoft.quantum.lang-ref.int),[int](xref:microsoft.quantum.lang-ref.int)), ([Double](xref:microsoft.quantum.lang-ref.double),[BlockEncodingReflection](xref:Microsoft.Quantum.Simulation.BlockEncodingReflection)))
