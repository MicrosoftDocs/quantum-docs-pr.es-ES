...
ms.locfileid: "96190792"
---
# <a name="applyphaseleoperationonlec-operation"></a>Operación ApplyPhaseLEOperationOnLEC
...
### <a name="op--phaselittleendian--unit--is-ctl"></a>OP: [PhaseLittleEndian](xref:Microsoft.Quantum.Arithmetic.PhaseLittleEndian) la => [unidad](xref:microsoft.quantum.lang-ref.unit) PhaseLittleEndian es CTL
