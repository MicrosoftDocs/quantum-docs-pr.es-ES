...
### <a name="trueop--t--unit-adj"></a>trueOp: ' t => de [unidad](xref:microsoft.quantum.lang-ref.unit)
...
### <a name="falseop--u--unit-adj"></a>falseOp: ' U => ajuste de [unidad](xref:microsoft.quantum.lang-ref.unit)
