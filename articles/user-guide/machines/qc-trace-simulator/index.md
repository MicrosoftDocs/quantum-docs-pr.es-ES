...
<span data-ttu-id="49c8f-111">Puede usar el simulador de seguimiento cuántico para ejecutar cualquier operación de Q#.</span><span class="sxs-lookup"><span data-stu-id="49c8f-111">You can use the quantum trace simulator to run any Q# operation.</span></span>
