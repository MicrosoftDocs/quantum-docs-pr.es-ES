...
description: 'Obtenga información sobre el estimador de recursos QDK de Microsoft, que estima los recursos necesarios para ejecutar una instancia determinada de una :::no-loc(Q#)::: operación en un equipo Quantum.'
author: anpaz-msft
ms.author: anpaz
ms.date: 06/26/2020
ms.topic: article
...
<span data-ttu-id="c9163-104">Como implica el nombre, la `ResourcesEstimator` clase calcula los recursos necesarios para ejecutar una instancia determinada de una :::no-loc(Q#)::: operación en un equipo Quantum.</span><span class="sxs-lookup"><span data-stu-id="c9163-104">As the name implies, the `ResourcesEstimator` class estimates the resources required to run a given instance of a :::no-loc(Q#)::: operation on a quantum computer.</span></span> <span data-ttu-id="c9163-105">Para ello, se ejecuta la operación Quantum sin simular realmente el estado de un equipo Quantum. por esta razón, calcula los recursos para :::no-loc(Q#)::: las operaciones que usan miles de qubits, siempre que la parte clásica del código se ejecute en un momento razonable.</span><span class="sxs-lookup"><span data-stu-id="c9163-105">It accomplishes this by running the quantum operation without actually simulating the state of a quantum computer; for this reason, it estimates resources for :::no-loc(Q#)::: operations that use thousands of qubits, provided that the classical part of the code runs in a reasonable time.</span></span>

<span data-ttu-id="c9163-106">El estimador de recursos se basa en el [simulador de seguimiento de Quantum](xref:microsoft.quantum.machines.qc-trace-simulator.intro), que proporciona un conjunto más completo de métricas y herramientas para ayudar a depurar :::no-loc(Q#)::: programas.</span><span class="sxs-lookup"><span data-stu-id="c9163-106">The resources estimator is built on top of the [Quantum trace simulator](xref:microsoft.quantum.machines.qc-trace-simulator.intro), which provides a richer set of metrics and tools to help debug :::no-loc(Q#)::: programs.</span></span>
...
<span data-ttu-id="c9163-108">Puede usar el estimador de recursos para ejecutar cualquier :::no-loc(Q#)::: operación.</span><span class="sxs-lookup"><span data-stu-id="c9163-108">You can use the resources estimator to run any :::no-loc(Q#)::: operation.</span></span> <span data-ttu-id="c9163-109">Para obtener más información, consulte [formas de ejecutar un :::no-loc(Q#)::: programa](xref:microsoft.quantum.guide.host-programs).</span><span class="sxs-lookup"><span data-stu-id="c9163-109">For additional details, see [Ways to run a :::no-loc(Q#)::: program](xref:microsoft.quantum.guide.host-programs).</span></span>
...
<span data-ttu-id="c9163-120">Use el método [estimate_resources ()](https://docs.microsoft.com/python/qsharp-core/qsharp.loader.qsharpcallable) de la biblioteca de Python con la :::no-loc(Q#)::: operación importada:</span><span class="sxs-lookup"><span data-stu-id="c9163-120">Use the [estimate_resources()](https://docs.microsoft.com/python/qsharp-core/qsharp.loader.qsharpcallable) method from the Python library with the imported :::no-loc(Q#)::: operation:</span></span>
...
<span data-ttu-id="c9163-122">Al ejecutar un :::no-loc(Q#)::: programa desde la línea de comandos, use el parámetro **--Simulator** (o **-s** Shortcut) para especificar el `ResourcesEstimator` equipo de destino.</span><span class="sxs-lookup"><span data-stu-id="c9163-122">When running a :::no-loc(Q#)::: program from the command line, use the **--simulator** (or **-s** shortcut) parameter to specify the `ResourcesEstimator` target machine.</span></span> <span data-ttu-id="c9163-123">El siguiente comando ejecuta un programa mediante el estimador de recursos:</span><span class="sxs-lookup"><span data-stu-id="c9163-123">The following command runs a program using the resources estimator:</span></span> 
...
<span data-ttu-id="c9163-125">Use la :::no-loc(Q#)::: [estimación del%](xref:microsoft.quantum.iqsharp.magic-ref.simulate) de comandos mágico para ejecutar la :::no-loc(Q#)::: operación.</span><span class="sxs-lookup"><span data-stu-id="c9163-125">Use the I:::no-loc(Q#)::: magic command [%estimate](xref:microsoft.quantum.iqsharp.magic-ref.simulate) to run the :::no-loc(Q#)::: operation.</span></span>
...
|<span data-ttu-id="c9163-144">__Profundidad__</span><span class="sxs-lookup"><span data-stu-id="c9163-144">__Depth__</span></span>|<span data-ttu-id="c9163-145">Profundidad del circuito de Quantum ejecutado por la :::no-loc(Q#)::: operación (vea [más abajo](#depth-width-and-qubitcount)).</span><span class="sxs-lookup"><span data-stu-id="c9163-145">Depth of the quantum circuit run by the :::no-loc(Q#)::: operation (see [below](#depth-width-and-qubitcount)).</span></span> <span data-ttu-id="c9163-146">De forma predeterminada, la métrica de profundidad solo cuenta las `T` puertas.</span><span class="sxs-lookup"><span data-stu-id="c9163-146">By default, the depth metric only counts `T` gates.</span></span> <span data-ttu-id="c9163-147">Para obtener más información, vea [contador de profundidad](xref:microsoft.quantum.machines.qc-trace-simulator.depth-counter).</span><span class="sxs-lookup"><span data-stu-id="c9163-147">For more details, see [Depth Counter](xref:microsoft.quantum.machines.qc-trace-simulator.depth-counter).</span></span>   |
|<span data-ttu-id="c9163-148">__Width__</span><span class="sxs-lookup"><span data-stu-id="c9163-148">__Width__</span></span>|<span data-ttu-id="c9163-149">Ancho del circuito de Quantum ejecutado por la :::no-loc(Q#)::: operación (vea [más abajo](#depth-width-and-qubitcount)).</span><span class="sxs-lookup"><span data-stu-id="c9163-149">Width of the quantum circuit run by the :::no-loc(Q#)::: operation (see [below](#depth-width-and-qubitcount)).</span></span> <span data-ttu-id="c9163-150">De forma predeterminada, la métrica de profundidad solo cuenta las `T` puertas.</span><span class="sxs-lookup"><span data-stu-id="c9163-150">By default, the depth metric only counts `T` gates.</span></span> <span data-ttu-id="c9163-151">Para obtener más información, vea [contador de profundidad](xref:microsoft.quantum.machines.qc-trace-simulator.depth-counter).</span><span class="sxs-lookup"><span data-stu-id="c9163-151">For more details, see [Depth Counter](xref:microsoft.quantum.machines.qc-trace-simulator.depth-counter).</span></span>   |
|<span data-ttu-id="c9163-152">__QubitCount__</span><span class="sxs-lookup"><span data-stu-id="c9163-152">__QubitCount__</span></span>    |<span data-ttu-id="c9163-153">Límite inferior para el número máximo de qubits asignado durante la ejecución de la :::no-loc(Q#)::: operación.</span><span class="sxs-lookup"><span data-stu-id="c9163-153">The lower bound for the maximum number of qubits allocated during the run of the :::no-loc(Q#)::: operation.</span></span> <span data-ttu-id="c9163-154">Es posible que esta métrica no sea compatible con la __profundidad__ (consulte a continuación).</span><span class="sxs-lookup"><span data-stu-id="c9163-154">This metric might not be compatible with __Depth__ (see below).</span></span>  |
|<span data-ttu-id="c9163-155">__BorrowedWidth__</span><span class="sxs-lookup"><span data-stu-id="c9163-155">__BorrowedWidth__</span></span>    |<span data-ttu-id="c9163-156">Número máximo de qubits prestado dentro de la :::no-loc(Q#)::: operación.</span><span class="sxs-lookup"><span data-stu-id="c9163-156">The maximum number of qubits borrowed inside the :::no-loc(Q#)::: operation.</span></span>  |
