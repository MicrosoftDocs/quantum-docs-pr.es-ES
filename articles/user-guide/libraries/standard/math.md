---
title: 'Matemáticas en las :::no-loc(Q#)::: bibliotecas estándar'
description: 'Obtenga información sobre las funciones matemáticas clásicas en las :::no-loc(Q#)::: bibliotecas estándar que se utilizan con los tipos de datos integrados.'
author: cgranade
...
<span data-ttu-id="d1e19-104">Estas funciones se utilizan principalmente para trabajar con los :::no-loc(Q#)::: tipos de datos integrados `Int` , `Double` y `Range` .</span><span class="sxs-lookup"><span data-stu-id="d1e19-104">These functions are primarily used to work with the :::no-loc(Q#)::: built-in data types `Int`, `Double`, and `Range`.</span></span>
