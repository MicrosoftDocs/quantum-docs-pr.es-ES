---
title: Biblioteca de aprendizaje automático de Quantum
author: alexeib2
...
La clasificación es una tarea de aprendizaje automático supervisado, donde el objetivo es deducir las etiquetas de clase $\{y_1, y_2, \ldots, y_d\}$ de ciertos ejemplos de datos. El "conjunto de datos de entrenamiento" es una colección de ejemplos $ \mathcal{D} =\{(x, y)} $ con etiquetas preasignadas conocidas. Aquí $x $ es una muestra de datos y $y $ es su etiqueta conocida denominada "etiqueta de entrenamiento".
