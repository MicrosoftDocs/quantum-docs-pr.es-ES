...
Autor: QuantumWriter UID: Microsoft. Quantum. Concepts. circuitos ms. Author: nawiebe@microsoft.com MS. Date: 12/11/2017 ms. topic: article no-LOC:
- "Q#"
- "$$v"
- "$$"
- "$$"
...
Por Convención, la línea superior es el registro $ 0 de qubit $ y el resto se etiqueta secuencialmente. El circuito de ejemplo anterior se representa como si actuara en dos qubits (o equivalentes en dos registros que se componen de un qubit).
...
es la matriz de la unitario $ CBA $ .
...
Como ejemplo de clarificación, podemos definir una operación de unitario de dos qubits $ B $ para que sea $ (H S \otimes X) $ y expresar el circuito de forma equivalente.

<!--- ![](.\media\4.svg) --->
<!--No encuentra una manera de centrar esto fácilmente... probablemente se trate de una extensión necesaria:-->
![Diagrama de circuitos de una operación de unitario de dos qubit](~/media/4.svg)

También podemos ver $ B $ como si tuviera una acción en un solo registro de dos qubit, en lugar de en 2 1-qubit, según el contexto en el que se use el circuito. Quizás la propiedad más útil de estos diagramas de circuitos abstractos es que permiten describir algoritmos Quantum complicados en un nivel alto sin tener que compilarlos en las puertas fundamentales.
