...
Hay algunos problemas tan difíciles y tan grandes, que incluso si cada superequipo del mundo trabajase en el problema en conjunto, se seguiría tardando más tiempo que la duración del universo. Los equipos cuánticos brindan la posibilidad de resolver algunos de los mayores desafíos del planeta: a nivel ambiental, de la agricultura, la salud, la energía, el clima, la ciencia de los materiales y otros que aún no se han imaginado. El impacto de los equipos cuánticos tendrá un gran alcance y un gran efecto, como la creación del transistor en 1947, que preparó el camino de la economía digital actual.

La computación cuántica aprovecha el comportamiento exclusivo de la física cuántica para proporcionar un nuevo y potente modelo de computación. La teoría de la física cuántica plantea esa cuestión, a un nivel cuántico puede estar en una superposición de varios estados clásicos. Y esos diferentes estados interfieren entre sí, como las olas en una piscina de olas.  Se da por hecho que el estado de la materia después de una medida "cae" en uno de los estados clásicos. Después, la repetición de la misma medida producirá el mismo resultado clásico.  El entrelazamiento cuántico se produce cuando las partículas interactúan de forma que el estado cuántico de cada una no se puede describir de forma completamente independiente de las demás, aunque las partículas estén físicamente alejadas.  
...
Los equipos clásicos codifican la información en bits; cada bit codifica 2 valores posibles, 0 o 1.  Un qubit codifica dos valores simultáneamente, 0 y 1.  Dos bits clásicos codifican uno de 4 valores posibles, (00, 01, 10, 11), mientras que 2 qubits codifican cualquier superposición de esos 4 valores simultáneamente, aunque solo podemos obtener uno de esos valores al medir.  Cuatro bits codifican uno de 16 valores.  Cuatro qubits codifican cualquier superposición de 16 valores simultáneamente, y así sucesivamente, de forma exponencial.  100 qubits pueden codificar más información de la que hay disponible en los sistemas informáticos más grandes actuales.  

Además, cuando varios qubits entrelazados actúan coherentemente, pueden procesar varias opciones simultáneamente. Esto les permite procesar información en una fracción del tiempo que tardarían incluso los sistemas no cuánticos más rápidos.
...
* Diseñar un plano de control criogénico único con disipación térmica y consumo extremadamente bajo. 
...
* [¿Qué puedo hacer con un equipo cuántico?](xref:microsoft.quantum.overview.computers)
