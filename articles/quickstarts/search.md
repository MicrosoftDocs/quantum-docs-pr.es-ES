...
1. Use el kit de desarrollo de Microsoft Quantum para [crear un nuevo proyecto de Q# para la aplicación de línea de comandos](xref:microsoft.quantum.install.standalone). Asigne al proyecto el nombre `Grover`.
